...
in the result list. Let’s look at how each function behaves and contributes to this approach:
    ...
    The list_sort function recursively retrieves words from a tree structure. It initializes an empty list to store
...
##################################
This is the same as trie/02_find_all_words_sol2.py
"""
